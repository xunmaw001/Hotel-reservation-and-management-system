...
public class JiudiankefuEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public JiudiankefuEntity() {
		
	}
	
	public JiudiankefuEntity(T t) {
		try {
	 ...
	 * 设置：客服号
	 */
	public void setKefuhao(String kefuhao) {
		this.kefuhao = kefuhao;
	}
	/**
	 * 获取：客服号
	 */
