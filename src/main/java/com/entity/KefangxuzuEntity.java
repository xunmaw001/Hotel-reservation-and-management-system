 ...
 */
@TableName("kefangxuzu")
public class KefangxuzuEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public KefangxuzuEntity() {
		
	}
	
	public KefangxuzuEntity(T t) {
		try {
	 ...
	 * 设置：续租时间
	 */
	public void setXuzushijian(Date xuzushijian) {
		this.xuzushijian = xuzushijian;
	}
	/**
	 * 获取：续租时间
	 */
	public Date getXuzushijian() {
		return xuzushijian;
	}
	/**
	 * 设置：续租天数
