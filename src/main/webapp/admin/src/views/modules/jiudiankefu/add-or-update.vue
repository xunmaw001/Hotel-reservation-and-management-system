<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="客服号" prop="kefuhao">
          <el-input v-model="ruleForm.kefuhao" 
              placeholder="客服号" clearable  :readonly="ro.kefuhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="客服号" prop="kefuhao">
              <el-input v-model="ruleForm.kefuhao" 
                placeholder="客服号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="客服姓名" prop="kefuxingming">
          <el-input v-model="ruleForm.kefuxingming" 
              placeholder="客服姓名" clearable  :readonly="ro.kefuxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="客服姓名" prop="kefuxingming">
              <el-input v-model="ruleForm.kefuxingming" 
                placeholder="客服姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='kefuhao'){
            this.ruleForm.kefuhao = obj[o];
	    this.ro.kefuhao = true;
            continue;
          }
          if(o=='mima'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiudiankefu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiudiankefuCrossAddOrUpdateFlag = false;
                  this.parent.search();
