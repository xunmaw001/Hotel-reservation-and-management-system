<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="订餐时间" prop="dingcanshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.dingcanshijian" 
                type="datetime"
                placeholder="订餐时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.dingcanshijian" label="订餐时间" prop="dingcanshijian">
              <el-input v-model="ruleForm.dingcanshijian" 
                placeholder="订餐时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="订餐食品" prop="dingcanshipin">
          <el-input v-model="ruleForm.dingcanshipin" 
              placeholder="订餐食品" clearable  :readonly="ro.dingcanshipin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="订餐食品" prop="dingcanshipin">
              <el-input v-model="ruleForm.dingcanshipin" 
                placeholder="订餐食品" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.dingcanshijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='dingcanshijian'){
            this.ruleForm.dingcanshijian = obj[o];
	    this.ro.dingcanshijian = true;
            continue;
          }
          if(o=='dingcanshipin'){
            this.ruleForm.dingcanshipin = obj[o];
	    this.ro.dingcanshipin = true;
            continue;
          }
          if(o=='zhanghao'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `kefangdingcan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kefangdingcanCrossAddOrUpdateFlag = false;
                  this.parent.search();
