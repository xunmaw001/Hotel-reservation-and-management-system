<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="房间设施" prop="fangjiansheshi">
          <el-input v-model="ruleForm.fangjiansheshi" 
              placeholder="房间设施" clearable  :readonly="ro.fangjiansheshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="房间设施" prop="fangjiansheshi">
              <el-input v-model="ruleForm.fangjiansheshi" 
                placeholder="房间设施" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="房间介绍" prop="fangjianjieshao">
                <el-input
