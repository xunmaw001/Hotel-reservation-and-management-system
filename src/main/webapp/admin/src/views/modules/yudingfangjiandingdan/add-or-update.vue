...
export default {
  ...
  methods: {
    ...
    info(id) {
      this.$http({
        url: `yudingfangjiandingdan/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../ssmd539t/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yudingfangjiandingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yudingfangjiandingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
