  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:rgba(36, 194, 205, 1);fontSize:28px;">酒店预约及管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='jiudiankefu'" class="input-group">
			   <div class="label">客服号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.kefuhao" class="input" type="text" placeholder="客服号">
			   </div>
			 </div> -->
			<el-form-item label="客服号" class="input" v-if="tableName=='jiudiankefu'">
			  <el-input v-model="ruleForm.kefuhao" autocomplete="off" placeholder="客服号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiudiankefu'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jiudiankefu'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='jiudiankefu'" class="input-group">
			   <div class="label">客服姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.kefuxingming" class="input" type="text" placeholder="客服姓名">
			   </div>
			 </div> -->
			<el-form-item label="客服姓名" class="input" v-if="tableName=='jiudiankefu'">
			  <el-input v-model="ruleForm.kefuxingming" autocomplete="off" placeholder="客服姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiudiankefu'" class="input-group">
			...
			<el-form-item label="性别" class="input" v-if="tableName=='jiudiankefu'">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='jiudiankefu'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiudiankefu'" class="input-group">
			...
			<el-form-item label="电话" class="input" v-if="tableName=='jiudiankefu'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='jiudiankefu'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.kefuhao) && `jiudiankefu` == this.tableName){
        this.$message.error(`客服号不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `jiudiankefu` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if((!this.ruleForm.kefuxingming) && `jiudiankefu` == this.tableName){
        this.$message.error(`客服姓名不能为空`);
        return
      }
      if(`jiudiankefu` == this.tableName && this.ruleForm.nianling&&(!this.$validate.isIntNumer(this.ruleForm.nianling))){
        this.$message.error(`年龄应输入整数`);
        return
      }
      if(`jiudiankefu` == this.tableName && this.ruleForm.dianhua&&(!this.$validate.isMobile(this.ruleForm.dianhua))){
        this.$message.error(`电话应输入手机格式`);
        return
      }
      if(`jiudiankefu` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
        this.$message.error(`邮箱应输入邮件格式`);
        return
      }
      if(`jiudiankefu` == this.tableName && this.ruleForm.money&&(!this.$validate.isNumber(this.ruleForm.money))){
        this.$message.error(`余额应输入数字`);
        return
      }
      this.$http({
